    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        setTimeout(() => {
          ...
          router.push(`/submission_asprak${queryString ? `?${queryString}` : ''}`);
        }, 2000);
      } else {
  ...
  if (loading) {
    return (
      <div className="w-full">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-white">Detail Submission</h1>
          <p className="text-blue-100 mt-2">Memuat data...</p>
        </div>
              ...
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-xs text-gray-500">
                    Disubmit oleh: {submission.nama_mahasiswa || "Mahasiswa"} ({submission.nim || "NIM"})
                  </p>
                </div>
              </div>
            ...
            <div className="p-6">
              <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div 
                      ...
                      className={`border-2 ${isDragActive ? "border-blue-400 bg-blue-50" : "border-dashed border-gray-300"} 
                        rounded-lg p-4 text-center cursor-pointer transition-all hover:border-blue-500 hover:bg-blue-50`}
                    >
                      <input {...getInputProps()} />
                      {file ? (
                ...
                <Button
                  ...
                  disabled={submitting}
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-md shadow-sm hover:shadow transition-all flex justify-center items-center"
                >
                  {submitting ? (
                    <>
