...
function AdminDashboardPage() {
  ...
  const fetchModules = useCallback(async () => {
    ...
    setError(null);
    try {
      const response = await fetch("http://localhost:8080/admin/get/modul/12");
      if (!response.ok) {
  ...
  try {
    const url = `http://localhost:8080/api/submodul/quiz-sdl/${submoduleId}`;
  ...
  const handleUpdateSubmodule = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`http://localhost:8080/admin/put/submodul/sdl/${selectedSubmodule.id_submodul}`, {
        method: "PUT",
        body: formDataToSend,
      });
...
const handleUpdateQuestion = async (e: React.FormEvent) => {
  ...
  try {
    const response = await fetch(`http://localhost:8080/admin/update/quiz/sdl/${quizId}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const handleDeleteSubmodule = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:8080/admin/delete/submodul/sdl/${selectedSubmodule.id_submodul}`, {
        method: "DELETE",
      });
  ...
  const handleDeleteQuestion = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:8080/admin/delete/quiz/sdl/${selectedQuestion.id_question}`, {
        method: "DELETE",
      });
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 font-sans">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-96 shadow-xl">
            ...
            <div className="w-full bg-gray-200 rounded-full h-2.5 mb-4">
              <div 
                className="bg-[#0267FE] h-2.5 rounded-full" 
      ...
      <div className="flex items-center justify-between bg-[#0267FE] p-4 text-white shadow-lg">
        <div className="flex items-center">
          ...
          <div className="flex items-center">
            ...
            <h1 className="text-2xl font-bold">Admin Dashboard - Praktikum SDL</h1>
          </div>
        </div>
        <div className="flex items-center space-x-4 bg-white bg-opacity-10 py-2 px-4 rounded-full backdrop-blur-sm">
      ...
      <div className="flex flex-grow">
        ...
        <button 
          className="lg:hidden fixed bottom-6 right-6 z-10 bg-[#0267FE] text-white p-3 rounded-full shadow-lg"
          ...
          <div className="flex justify-between items-center p-4 border-b border-gray-200 bg-gray-50">
            {isSidebarExpanded ? (
              <h2 className="text-xl font-bold text-gray-800 flex items-center">
                <FaBookOpen className="mr-2 text-[#0267FE]" />
                Modules
              </h2>
            ) : (
              <span className="mx-auto text-[#0267FE]">
                <FaBookOpen className="text-xl" />
              </span>
            )}
            <button
              onClick={() => setIsSidebarExpanded(prev => !prev)}
              className="text-[#0267FE] hover:bg-blue-50 p-2 rounded-full transition-colors"
          ...
          <div className="overflow-y-auto flex-grow">
            {loading ? (
              <div className="flex justify-center items-center h-32">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 bg-[#0267FE]"></div>
              </div>
            ) : error ? (
              <div className="p-4 text-center">
                ...
                <button 
                  onClick={handleRetry}
                  className=" text-white px-4 py-2 rounded-lg text-sm bg-[#0267FE] hover:bg-[hsl(222,99%,50%)] transition-colors"
                >
                  Retry Loading
                </button>
              </div>
                ...
                {modules.map((module) => (
                  module.judul_modul !== "Informasi" && (
                    <li key={module.id_modul} className="mb-3">
                      ...
                      >
                        <div className="flex items-center">
                          <div className="mr-3 text-[#0267FE] bg-blue-50 p-2 rounded-full">
                        ...
                        <button
                          ...
                          className="text-gray-500 hover:text-[#0267FE] p-1 rounded-full hover:bg-gray-100"
                          ...
                          {selectedModule?.id_modul === module.id_modul && (
                            <div className="ml-12 mt-2">
                              <button
                                ...
                                className="text-sm flex items-center text-[#0267FE] hover:text-[hsl(222,99%,50%)] p-1 rounded"
                              >
                ...
                {modules.map((module) => (
                  module.judul_modul !== "Informasi" && (
                    <li key={module.id_modul} className="mb-2">
                      ...
                      >
                        <FaBookOpen className="text-[#0267FE]" />
                      </div>
                    </li>
                  )
                ))}
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <form onSubmit={handleAddModule}>
                ...
                <div className="flex justify-end space-x-3">
                  ...
                  <button
                    type="submit"
                    className="bg-[#0267FE] hover:bg-[hsl(222,99%,50%)] text-white px-5 py-2 rounded-lg transition-colors"
                  >
                    Add Module
                  </button>
                </div>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-2 flex items-center">
                      ...
                      <button
                        ...
                        className="bg-blue-100 text-[#0267FE] p-3 rounded-lg hover:bg-blue-200"
                      >
                        <FaUpload />
                      </button>
                    </div>
              ...
              <div className="flex justify-between mb-6">
                <div>
                  <div className="flex items-center mb-1">
                    <button
                      ...
                      className="text-[#0267FE] hover:bg-blue-50 p-2 rounded-full mr-2"
                    >
                      <FaChevronLeft />
                    </button>
                ...
                <div className="flex items-center">
                  <button
                    ...
                    className="flex items-center text-[#0267FE] hover:bg-blue-50 p-2 rounded-lg mr-2"
                  >
                      ...
                      <li>
                        <button
                          ...
                          className={`pb-3 transition-colors ${
                            activeTab === "details"
                              ? "text-[#0267FE] border-b-2 border-blue-600 font-medium"
                    ...
                    <div>
                      <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                        ...
                        <div className="aspect-w-16 aspect-h-9">
                          <iframe 
                            src={selectedSubmodule.video_url} 
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="text-center py-12">
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-2">
                  Welcome to SDL Praktikum Admin Panel
                </h2>
